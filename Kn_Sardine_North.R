...
# Remove SSt to check if the model improves 
m0b<- gam((Kn_trend)~s(CRTY_trend,k=4)+s(NPP_trend,k=4),data=data_Kn,method="REML")#
summary(m0b)
m0b$aic###### AIC=-691.2924; R-sq (adj) = 0.397;  Deviance explained= 42.6%
appraise(m0b)
res <- resid(m0b)
plot(res)
